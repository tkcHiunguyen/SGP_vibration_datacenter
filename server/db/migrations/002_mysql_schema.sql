...
SET @add_device_datas_vrms_y_mms_sql := IF(@has_device_datas_vrms_y_mms = 0, 'ALTER TABLE device_datas ADD COLUMN vrms_y_mms DOUBLE NULL AFTER vrms_x_mms', 'SELECT 1');
...
SET @add_device_datas_vrms_z_mms_sql := IF(@has_device_datas_vrms_z_mms = 0, 'ALTER TABLE device_datas ADD COLUMN vrms_z_mms DOUBLE NULL AFTER vrms_y_mms', 'SELECT 1');
...
SET @add_device_datas_vrms_unit_sql := IF(@has_device_datas_vrms_unit = 0, 'ALTER TABLE device_datas ADD COLUMN vrms_unit VARCHAR(32) NULL AFTER vrms_z_mms', 'SELECT 1');
...
SET @add_device_datas_drms_x_um_sql := IF(@has_device_datas_drms_x_um = 0, 'ALTER TABLE device_datas ADD COLUMN drms_x_um DOUBLE NULL AFTER vrms_unit', 'SELECT 1');
...
SET @add_device_datas_drms_y_um_sql := IF(@has_device_datas_drms_y_um = 0, 'ALTER TABLE device_datas ADD COLUMN drms_y_um DOUBLE NULL AFTER drms_x_um', 'SELECT 1');
...
SET @add_device_datas_drms_z_um_sql := IF(@has_device_datas_drms_z_um = 0, 'ALTER TABLE device_datas ADD COLUMN drms_z_um DOUBLE NULL AFTER drms_y_um', 'SELECT 1');
...
SET @add_device_datas_drms_band_min_hz_sql := IF(@has_device_datas_drms_band_min_hz = 0, 'ALTER TABLE device_datas ADD COLUMN drms_band_min_hz DOUBLE NULL AFTER drms_z_um', 'SELECT 1');
...
SET @add_device_datas_drms_band_max_hz_sql := IF(@has_device_datas_drms_band_max_hz = 0, 'ALTER TABLE device_datas ADD COLUMN drms_band_max_hz DOUBLE NULL AFTER drms_band_min_hz', 'SELECT 1');
...
SET @add_device_datas_drms_unit_sql := IF(@has_device_datas_drms_unit = 0, 'ALTER TABLE device_datas ADD COLUMN drms_unit VARCHAR(32) NULL AFTER drms_band_max_hz', 'SELECT 1');
...
SET @has_idx_device_datas_received_at := (
  SELECT COUNT(*)
  FROM information_schema.statistics
  WHERE table_schema = DATABASE()
    AND table_name = 'device_datas'
    AND index_name = 'idx_device_datas_received_at'
);
SET @add_idx_device_datas_received_at_sql := IF(
  @has_idx_device_datas_received_at = 0,
  'ALTER TABLE device_datas ADD KEY idx_device_datas_received_at (received_at)',
  'SELECT 1'
);
PREPARE add_idx_device_datas_received_at_stmt FROM @add_idx_device_datas_received_at_sql;
EXECUTE add_idx_device_datas_received_at_stmt;
DEALLOCATE PREPARE add_idx_device_datas_received_at_stmt;

SET @has_idx_device_spectrum_frames_captured_at := (
  SELECT COUNT(*)
  FROM information_schema.statistics
  WHERE table_schema = DATABASE()
    AND table_name = 'device_spectrum_frames'
    AND index_name = 'idx_device_spectrum_frames_captured_at'
);
SET @add_idx_device_spectrum_frames_captured_at_sql := IF(
  @has_idx_device_spectrum_frames_captured_at = 0,
  'ALTER TABLE device_spectrum_frames ADD KEY idx_device_spectrum_frames_captured_at (captured_at)',
  'SELECT 1'
);

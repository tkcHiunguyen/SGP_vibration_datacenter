...
export interface DeviceRepository {
  ...
  clearTelemetryDataBatchUntil(deviceId: string, cutoffAt: string, limit: number): Promise<number>;
  countTelemetryDataUntil(deviceId: string, cutoffAt: string): Promise<number>;

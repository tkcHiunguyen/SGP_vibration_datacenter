...
CREATE TABLE IF NOT EXISTS data_import_jobs (
  ...
  progress SMALLINT UNSIGNED NOT NULL DEFAULT 0,
  stage_progress SMALLINT UNSIGNED NOT NULL DEFAULT 0,
  file_name VARCHAR(255) NOT NULL,
  file_path VARCHAR(1024) NOT NULL,
  file_sha256 CHAR(64) NOT NULL,
  size_bytes BIGINT UNSIGNED NOT NULL DEFAULT 0,
  mode VARCHAR(32) NOT NULL DEFAULT 'merge',
  total_devices BIGINT UNSIGNED NOT NULL DEFAULT 0,
  total_measurements BIGINT UNSIGNED NOT NULL DEFAULT 0,
  total_spectrum BIGINT UNSIGNED NOT NULL DEFAULT 0,
  total_placement_configs BIGINT UNSIGNED NOT NULL DEFAULT 0,
  processed_devices BIGINT UNSIGNED NOT NULL DEFAULT 0,
  processed_measurements BIGINT UNSIGNED NOT NULL DEFAULT 0,
  processed_spectrum BIGINT UNSIGNED NOT NULL DEFAULT 0,
  processed_placement_configs BIGINT UNSIGNED NOT NULL DEFAULT 0,
  ...
  current_device_id VARCHAR(191) NULL,
  records_per_second DOUBLE NOT NULL DEFAULT 0,
  estimated_seconds_remaining BIGINT UNSIGNED NULL,
  ...
  expires_at DATETIME(3) NULL,
  PRIMARY KEY (id),
  UNIQUE KEY uq_data_import_jobs_job_id (job_id),
  UNIQUE KEY uq_data_import_jobs_upload_id (upload_id),
  KEY idx_data_import_jobs_status_created (status, created_at),
  KEY idx_data_import_jobs_expires_at (expires_at)
);
